# -*- encoding: utf-8 -*-
# stub: rspec-rails 3.3.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2015-07-15"
  s.description = "rspec-rails is a testing framework for Rails 3.x and 4.x.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.3.0"])
      s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.3.0"])
      s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.3.0"])
      s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.3.0"])
      ...
      s.add_dependency(%q<rspec-core>.freeze, ["~> 3.3.0"])
      s.add_dependency(%q<rspec-expectations>.freeze, ["~> 3.3.0"])
      s.add_dependency(%q<rspec-mocks>.freeze, ["~> 3.3.0"])
      s.add_dependency(%q<rspec-support>.freeze, ["~> 3.3.0"])
